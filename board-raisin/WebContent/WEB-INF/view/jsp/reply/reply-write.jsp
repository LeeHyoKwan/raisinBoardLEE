...
<main class="main_layout">
	<section>
		<form name="commentView_form"method="post" action="../reply/replyEditAction">
				...
				<article id="write_wrap">
					<div >
						<header>
							<div class="header_div">
								...
								<div class="writer">
									<div class="writer_lf">
										<span>
											<s:label name="replyDto.createuser" />
										</span>
										<span class="writer_dt">
											<s:label name="replyDto.createdt" />
										</span>
									</div>
								</div>
							</div>
						...
						<div class="content_div" style="border-bottom: 1px solid #ded7d79c !important;">
							<s:textarea class="cmt_txta_edi" id="comment" type="text" name="replyDto.content" maxlength="400" onkeypress="userKeyPress('edit')"/>
						</div>
				...
				<!-- 現在掲示板番号 -->
				<s:hidden id="boardid"  type="text" name="replyDto.boardid" />
				<!-- 現在掲示板のコメント番号 -->
				<s:hidden id="commentid"  type="text" name="replyDto.commentid" />
				<!-- 現在掲示板のreply番号 -->
				<s:hidden id="replyid"  type="text" name="replyDto.replyid" />
		</form>
	</section>
</main>
</body>
